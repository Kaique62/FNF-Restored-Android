...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'tutorial':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/tutorial-dialogue'));
			case 'bopeebo':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/bopeebo-dialogue'));	
			case 'fresh':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/fresh-dialogue'));
			case 'dadbattle':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/dadbattle-dialogue'));
			case 'spookeez':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/spookeez-dialogue'));
			case 'south':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/south-dialogue'));
			case 'pico':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/pico-dialogue'));
			case 'philly':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/philly-dialogue'));			
			case 'blammed':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/blammed-dialogue'));
			case 'satin-panties':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/satin-panties-dialogue'));
			case 'cocoa':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/cocoa-dialogue'));
			case 'eggnog':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/eggnog-dialogue'));
			case 'winter-horrorland':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/winter-horrorland-dialogue'));										
			case 'high':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/high-dialogue'));										
			case 'milf':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dialogues/milf-dialogue'));																																					
			case 'senpai':
